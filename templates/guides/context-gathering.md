# APM Semi {VERSION} - Context Gathering Guide
...
- *Listen for sovereignty signals:* Alongside the existing focuses, listen for signs the User wants direct ownership over part of the work - domain preferences, areas stressed about, parts the User describes as critical or wants full personal knowledge of, parts described with strong personal language, or explicit statements of intent to do certain work themselves. APM Semi's typical pattern is the User taking on the critical or high-stakes work and AI Workers handling the boilerplate or peripheral work that depends on it - listen for which side a given area falls on. Surface a recommendation alongside normal questioning when a signal appears; remain a question-asker, do not pressure. Capture signals as observations about the work the User wants direct ownership over - they feed into Work Breakdown the same way other gathered context does.
...
- *Sovereignty signals:* areas of work the User wants direct ownership over per §2.2 Guiding Principles. Record what was signaled and where it surfaced - parts the User stressed about, parts the User explicitly said they want to build themselves, areas described with strong personal language. Frame in terms of the work itself, not its eventual decomposition.
