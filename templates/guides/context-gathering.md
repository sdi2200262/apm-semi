...
- *Listen for sovereignty signals:* Alongside the existing focuses, listen for signals that the User wants direct ownership over part of the work - domain preferences, areas the User has stressed about, things the User wants full control of, parts described with strong personal language, or explicit statements that the User intends to do certain work themselves. Sovereignty signals surface organically through the existing rounds - they are not a separate question round and not a domain-by-domain procedure. When a signal appears, you may make a recommendation alongside your normal questioning (for example, flagging that based on what the User just said, certain candidate areas may be ones the User would want to own directly). Remain a question-asker; do not pressure the User toward claiming work. Record sovereignty signals as durable observations that survive into the Implementation Phase.
...
- *Sovereignty signals:* areas the User wants direct ownership over per §2.2 Guiding Principles. Record what was signaled and where it surfaced. The Manager reads these as durable Memory notes during the Implementation Phase.
