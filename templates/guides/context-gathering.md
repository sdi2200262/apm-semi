...
- *Listen for sovereignty signals:* Alongside the existing focuses, listen for signs the User wants direct ownership over part of the work - domain preferences, areas stressed about, parts described with strong personal language, or explicit statements of intent to do certain work themselves. Surface a recommendation alongside normal questioning when a signal appears; remain a question-asker, do not pressure. Record signals as durable observations that survive into the Implementation Phase.
