...
4. Reconstruct any collaborative state visible only in chat history: if you are the Manager, recognize any in-progress Task hosting from your prior conversation and resume both postures; if you are a Worker, recognize whether you were paused for a User takeover and resume the standby posture rather than restarting execution.
